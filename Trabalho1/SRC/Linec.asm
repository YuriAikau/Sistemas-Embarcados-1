...
;desenhar retas
		...
		mov		word[cor],branco_intenso	;antenas
		mov		ax,20
		push		ax
		mov		ax,400
		push		ax
...
;desenha circulos 
		...
		mov		word[cor],vermelho	;circulos vermelhos
		mov		ax,500
		push		ax
		mov		ax,300
		push		ax
...
l4:
		...
		inc		word [cor]		;mudar a cor para a seguinte
    	loop    l4
